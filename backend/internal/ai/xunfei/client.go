// Package xunfei 讯飞星火客户端
// 讯飞星火兼容 OpenAI API 协议
// API 文档: https://www.xfyun.cn/doc/spark/HTTP调用文档.html
package xunfei
...
const (
	ModelSparkLite   = "lite"
	ModelSparkPro    = "generalv3"
	ModelSparkMax    = "generalv3.5"
	ModelSpark4Ultra = "4.0Ultra"
)
...
func wrapError(err error) error {
	return &aiinterface.ClientError{
		Type:    aiinterface.ErrorTypeServerError,
		Message: fmt.Sprintf("讯飞星火请求失败: %v", err),
		Err:     err,
	}
}
