...
type Model struct {
	...
	Provider string `json:"provider" gorm:"size:50;not null"` // openai, anthropic, google, azure, deepseek, qwen, ollama, custom
	...
	Features           ModelFeatures  `json:"features" gorm:"type:jsonb;default:'{}'"`     // 能力特性
